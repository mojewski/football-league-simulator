...
public class NameRepository {
    ...
    public List<String> getFirstNamesForCountry(Country country) {
        return firstNames.getOrDefault(country, DEFAULT_FIRST_NAME);
    }

    public List<String> getLastNamesForCountry(Country country) {
        return lastNames.getOrDefault(country, DEFAULT_LAST_NAME);
    }
